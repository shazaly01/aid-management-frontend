  ...
  >
    <div class="flex h-16 items-center justify-between px-5 flex-shrink-0">
      <RouterLink :to="{ name: 'Dashboard' }" class="flex items-center gap-2">
        ...
        <h1 class="text-xl font-bold text-text-primary">نظام باندا الخيري</h1>
      </RouterLink>
      <button
...
import {
  ...
  Cog6ToothIcon,
  ChevronDownIcon,
  UserGroupIcon, // أيقونة للمستفيدين
  BanknotesIcon, // أيقونة للمالية والخزائن
...
// --- بنية البيانات الجديدة لقائمة الجمعية الخيرية ---
  ...
  { name: 'لوحة التحكم', routeName: 'Dashboard', icon: HomeIcon, permission: 'dashboard.view' },
  {
    ...
    children: [
      { name: 'المستفيدون', routeName: 'BeneficiariesList', permission: 'beneficiary.view' },
      {
        ...
        permission: 'in_kind_assistance.view',
      },
      {
        name: 'المساعدات المالية',
        routeName: 'FinancialAssistancesList',
        permission: 'financial_assistance.view',
      },
    ],
  },
  {
    name: 'المالية والخزائن',
    icon: BanknotesIcon,
    permission: 'treasury.view',
    children: [
      { name: 'الخزائن', routeName: 'TreasuriesList', permission: 'treasury.view' },
      { name: 'حركات الخزينة', routeName: 'TreasuryTransactionsList', permission: 'treasury.view' },
    ],
  },
  {
    name: 'التقارير',
    icon: DocumentChartBarIcon,
    permission: 'dashboard.view', // يمكن تعديلها لصلاحية تقارير عامة إن وجدت
    children: [
      { name: 'كشف حساب خزينة', routeName: 'TreasuryStatementReport', permission: 'treasury.view' },
      {
        name: 'كشف حساب مستفيد',
        routeName: 'BeneficiaryStatementReport',
        permission: 'beneficiary.view',
      },
      {
        name: 'توزيع المساعدات العينية',
        routeName: 'InKindDistributionReport',
        permission: 'in_kind_assistance.view',
      },
      {
        name: 'المساعدات المالية',
        routeName: 'FinancialAidByTypeReport',
        permission: 'financial_assistance.view',
      },
      { name: 'الأرصدة الشاملة', routeName: 'GlobalBalancesReport', permission: 'treasury.view' },
    ],
  },
  {
    name: 'الإدارة',
