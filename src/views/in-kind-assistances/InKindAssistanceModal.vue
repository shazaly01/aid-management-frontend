<template>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="bg-surface-section rounded-lg shadow-xl p-6 w-full max-w-3xl transform max-h-[90vh] flex flex-col"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <div class="overflow-y-auto pr-1 flex-1 custom-scrollbar">
            <InKindAssistanceForm
              :initial-data="assistance"
              :is-saving="isSaving"
...
import InKindAssistanceForm from './InKindAssistanceForm.vue'
...
const title = computed(() =>
  props.assistance && props.assistance.id ? 'تعديل مساعدة عينية' : 'تسجيل مساعدة عينية جديدة',
)
...
<style scoped>
/* تنسيق خفيف لشريط التمرير داخل الـ Modal إذا كثرت الأصناف */
