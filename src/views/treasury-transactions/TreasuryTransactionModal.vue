<template>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="bg-surface-section rounded-lg shadow-xl p-6 w-full max-w-2xl transform max-h-[90vh] overflow-y-auto custom-scrollbar"
          role="dialog"
          aria-modal="true"
...
import TreasuryTransactionForm from './TreasuryTransactionForm.vue'
...
const title = computed(() =>
  props.transaction && props.transaction.id ? 'تعديل حركة الخزينة' : 'تسجيل حركة مالية جديدة',
)
