...
import FinancialAssistanceForm from './FinancialAssistanceForm.vue'
...
const title = computed(() =>
  props.assistance && props.assistance.id
    ? 'تعديل بيانات المساعدة المالية'
    : 'تسجيل مساعدة مالية جديدة',
)
